@extends('layout')
@section('google-font')
{{asset('https://fonts.googleapis.com/css?family=Poppins:200,300,400,500,600,700,800,900&display=swap')}}
@endsection
@section('style-open-iconic')
{{asset('public/css/open-iconic-bootstrap.min.css')}}
@endsection
@section('style-animate')
{{asset('public/css/animate.css')}}
@endsection
@section('style-owl-carousel')
{{asset('public/css/owl.carousel.min.css')}}
@endsection
@section('style-owl-theme')
{{asset('public/css/owl.theme.default.min.css')}}
@endsection
@section('style-magnific')
{{asset('public/css/magnific-popup.css')}}
@endsection
@section('style-aos')
{{asset('public/css/aos.css')}}
@endsection
@section('style-ionicons')
{{asset('public/css/ionicons.min.css')}}
@endsection
@section('style-flaticon')
{{asset('public/css/flaticon.css')}}
@endsection
@section('style-icomoon')
{{asset('public/css/icomoon.css')}}
@endsection
@section('style')
{{asset('public/css/style.css')}}
@endsection
<!-- Content is going throught this section -->
@section('content')
<body>
    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-center align-items-stretch">
    			<div class="col-md-4 d-flex align-items-center py-4">
    				<a class="navbar-brand" href="index.html">Arsi. <span>University</span></a>
    			</div>
	    		<div class="col-lg-8 d-block">
		    		<div class="row d-flex">
					    <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
					    	...
					    	<div class="text">
					    		<span>Email</span>
						    	<span>girmaefrem6@email.com</span>
						    </div>
					    </div>
					    <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
			...
			<div class="container">
				<div class="row d-flex">
					<div class="col-md-5 order-md-last wrap-about wrap-about d-flex align-items-stretch">
						<div class="img" style="background-image: url({{asset('public/images/about.jpg')}}); border"></div>
					</div>
            ...
            <p>Separated they live in. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country</p>
				...
				<div class="row">
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url('{{aesst("images/course-1.jpg)"}}');"></div>
						<div class="text pt-4">
							<p class="meta d-flex">
      ...
      <div class="container">
    	...
    	<div class="container-wrap">
    		<div class="row no-gutters">
					...
					<div class="col-md-3 ftco-animate">
						<a href="{{asset(images/image_2.jpg)}}" class="gallery image-popup img d-flex align-items-center" style="background-image: url('{{asset("images/image_2)"}}');">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-instagram"></span>
    					</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="{{asset(images/image_3.jpg)}}" class="gallery image-popup img d-flex align-items-center" style="background-image: url('{{asset("images/image_3)"}}');">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-instagram"></span>
    					</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="{{asset(images/image_4.jpg)}}" class="gallery image-popup img d-flex align-items-center" style="background-image: url('{{asset("images/image_4)"}}');">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-instagram"></span>
    					</div>
						</a>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-5">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url('{{asset("images/image_1)"}}');"></a>
                <div class="text">
...
@endsection
@section('js-migrate')
{{asset('public/js/jquery-migrate-3.0.1.min.js')}}
@endsection
@section('js-popper')
{{asset('public/js/popper.min.js')}}
@endsection
@section('js-bootstrap')
{{asset('public/js/bootstrap.min.js')}}
@endsection
@section('js-easing')
{{asset('public/js/jquery.easing.1.3.js')}}
@endsection
@section('js-waypoints')
{{asset('public/js/jquery.waypoints.min.js')}}
@endsection
@section('js-stellar')
{{asset('public/js/jquery.stellar.min.js')}}
@endsection
@section('js-carousel')
{{asset('public/js/owl.carousel.min.js')}}
@endsection
@section('js-magnific-popup')
{{asset('public/js/jquery.magnific-popup.min.js')}}
@endsection
@section('js-aos')
{{asset('public/js/aos.js')}}
@endsection
@section('js-animateNumber')
{{asset('public/js/jquery.animateNumber.min.js')}}
@endsection
@section('js-scrollax')
{{asset('public/js/scrollax.min.js')}}
@endsection
@section('api')
{{asset('https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false')}}
@endsection
@section('google')
{{asset('public/js/google-map.js')}}
@endsection
@section('main')
{{asset('public/js/main.js')}}
@endsection
