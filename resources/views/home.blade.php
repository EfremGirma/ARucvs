...
{{asset('css/open-iconic-bootstrap.min.css')}}
@endsection
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center px-4">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
			...
			<li class="nav-item"><a href="courses.html" class="nav-link">Home</a></li>
			@if (Route::has('login'))
...
@endif
					...
					<li class="nav-item my-auto"><a href="{{ route('login') }}" class="nav-link mr-auto">Log in</a></li>
						...
						<li class="nav-item my-auto">   <a href="{{ route('register.get') }}"class="nav-link" >Register</a></li>
                        @endif
                    @endauth
			...
			<div class="container">
				<div class="row d-flex">
					<div class="col-md-5 order-md-last wrap-about wrap-about d-flex align-items-stretch">
						<div class="img" style="background-image: url(images/about.jpg); border:0cm;"></div>
					</div>
