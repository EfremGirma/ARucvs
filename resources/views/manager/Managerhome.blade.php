...
<div class="d-flex align-items-center justify-content-between">
  <a href="index.html" class="logo d-flex align-items-center">
    ...
    <span class="d-none d-lg-block">Arsi Univrsity CV System(manager)</span>
  </a>
...
<nav class="header-nav ms-auto">
  <ul class="d-flex align-items-center">
    ...
    <li class="nav-item d-block d-lg-none">
      <a class="nav-link nav-icon search-bar-toggle " href="{{route('home.get')}}">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        ...
        <li>
          <a class="dropdown-item d-flex align-items-center" href="users-profile.html">
            ...
            <span><a href="{{route('managerProfile.get')}}">Profile</a></span>
          </a>
        </li>
        <li>
          <hr class="dropdown-divider">
  ...
  <li class="nav-item">
    ...
    <li>
        <a href="forms-elements.html">
          <i class="bi bi-circle"></i><span>Form Register</span>
        </a>
      </li>
      <li>
      ...
      <li>
        <a href="forms-editors.html">
          <i class="bi bi-circle"></i><span>Edit Register</span>
        </a>
      </li>
      <li>
